class Student::VirtualBoothController < Student::BaseController
  ...
  def show
    ...
    unless @meeting.active?
      if @meeting.start_time.utc > Time.current.utc
        ...
        flash.now[:notice] = "This meeting has been cancelled."
  ...
  def check_participant
    unless @meeting.participant?(current_user)
      redirect_to student_virtual_booth_index_path, alert: "You are not a participant in this meeting."
    end
  end
end
